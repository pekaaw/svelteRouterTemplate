...
function create_each_block(ctx) {
	var li, a, t_value = ctx.page.name + "", t, a_href_value, dispose;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { activePage: 1 }) => {
		if ($$dirty.activePage) { $$invalidate('isActive', isActive = route => {
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			dispose = [
				listen_dev(a0, "click", ctx.navigator.navigate),
				listen_dev(a1, "click", ctx.navigator.navigate),
				listen_dev(a2, "click", ctx.navigator.navigate)
			];
		},
...
class BlogEntry extends SvelteComponentDev {
	constructor(options) {
		...
		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "BlogEntry", options, id: create_fragment$5.name });
...
class Back extends SvelteComponentDev {
	constructor(options) {
		...
		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Back", options, id: create_fragment$6.name });
	}
}
...
class BlogNewEntry extends SvelteComponentDev {
	constructor(options) {
		...
		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "BlogNewEntry", options, id: create_fragment$7.name });
	}
}
